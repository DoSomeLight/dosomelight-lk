	...
	[0],
	{
		...
		942: function (module, __webpack_exports__, __webpack_require__) {
			...
			var objectWithoutPropertiesLoose = __webpack_require__(47),
				...
				inheritsLoose = __webpack_require__(132),
				react = __webpack_require__(0),
				react_default = __webpack_require__.n(react),
				react_dom = __webpack_require__(156),
			...
			var enums = __webpack_require__(454)
			...
			function detectOverflow(state, options) {
				...
				if (elementContext === enums.i && offsetData) {
					...
					Object.keys(overflowOffsets).forEach(function (key) {
						var multiply =
								[enums.k, enums.c].indexOf(key) >= 0
									? 1
									: -1,
							axis =
								[enums.m, enums.c].indexOf(key) >= 0
									? 'y'
									: 'x'
			...
			var popper_createPopper = popperGenerator({
				...
				react_fast_compare = __webpack_require__(398),
			...
			var warning = __webpack_require__(889),
				...
				return (
					...
					(_proto.render = function render() {
						var _this2 = this,
							...
							restProps = Object(
								objectWithoutPropertiesLoose.a
							)(_this$props, [
								'children',
								'tooltip',
								'placement',
